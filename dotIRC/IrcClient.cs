...
namespace dotIRC
{
    ...
    public partial class IrcClient : IDisposable
    {
        ...
        private const int socketReceiveBufferSize = 0xfffff;
        ...
        public IrcClient()
        {
            ...
            this.numericMessageProcessors = new Dictionary<int, MessageProcessor>();
        ...
        private void ReceiveCompleted(object sender, SocketAsyncEventArgs e)
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    int her = lineAfterPrefix.IndexOf(' ');
                    //if (her == -1) {
                    ...
                    //    // убить убить убить убить убить убить убить убить убить убить убить убить убить убить
                    //}
                    var command = lineAfterPrefix.Substring(0, her);
...
//#endif
        ...
        private void HandleClientConnected(IrcRegistrationInfo regInfo)
        {
           ...
           // messageSendQueue.Enqueue(Tuple.Create("TWITCHCLIENT 2\x0D\x0A\x00\x00", (object)null));
            ...
            else
            {
                ...
                if (userRegInfo.NickName != null )
                    SendMessageNick(userRegInfo.NickName);
                if (userRegInfo.UserName != null)
